---
author: ziishaned
header_img: _posts/img/regexp-en.png
source: github
source_file: 
source_url: https://github.com/ziishaned/learn-regex/blob/master/README.md
subtitle: A regular expression is a group of characters or symbols which is used to find a specific pattern in a text.
tags: []
...
<br/><br/>
<p align="center">
  <img src="{{site.cdn_img_raw}}/_posts/img/regexp-en.png" alt="Regular expression">
</p>
